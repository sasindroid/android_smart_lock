...
//                .setSupportsPasswordLogin(true)
        ...
        Auth.CredentialsApi.request(mGoogleApiClient, request).setResultCallback(
                new ResultCallback<CredentialRequestResult>() {
                    ...
                    public void onResult(CredentialRequestResult credentialRequestResult) {
                        ...
                        Log.d(TAG, "CredentialRequestResult: " + status.toString() + " - RESULT: " + credentialRequestResult.getStatus().isSuccess());
                        ...
                        if (credentialRequestResult.getStatus().isSuccess()) {
                            ...
                            Log.d(TAG, "credentialRequestResult.getStatus().isSuccess()");
    ...
    private void resolveResult(Status status, int requestCode) {
        ...
        if (status.hasResolution()) {
            ...
            try {
                // The below would call onActivityForResult to save or never based on user's decision.
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SAVE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(getBaseContext(), "Credential Read Failed", Toast.LENGTH_SHORT).show();
            }
        }
        mIsResolving = false;
    }
